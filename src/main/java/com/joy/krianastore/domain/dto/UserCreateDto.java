 ...
 */
public record UserCreateDto(@Email(message = "Provide a valid email") @NotNull String email, @NotNull @Size(min = 5,max = 8,message = "Password must be 5 to 8 characters long") String password,@NotNull(message = "Roles must be ADMIN or READ_WRITE or READ_ONLY") Role role) {
}
